  ...
  return (
    <div className="w-[20%] h-full bg-zinc-800 p-5">
      ...
      <nav className="mt-10 mb-5 text-zinc-400 flex flex-col gap-2">
        ...
        {[{name:"Trending",icon:"ri-fire-fill",forwardTo: "/trending"},{name:"Popular",icon:"ri-sparkling-fill",forwardTo: "/popular"},{name:"Movies",icon:"ri-movie-2-fill",forwardTo: "/movie"},{name:"Tv Shows",icon:"ri-tv-2-fill",forwardTo: "/tv"},{name:"People",icon:"ri-team-fill",forwardTo: "/people"}].map(
          (navLink) => (
